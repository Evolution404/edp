...
| D | 发布可靠性与 recovery 可观测性 | IN PROGRESS（D1/D2 DONE；D4 因 2026-09-05 fresh-insertion mount/claim race 重新打开；D3 缺失物理负样本 fixture 仍按发布清单 BLOCKED_BY_FIXTURE 记录） |
